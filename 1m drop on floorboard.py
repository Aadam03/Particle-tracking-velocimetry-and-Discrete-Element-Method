# -*- coding: utf-8 -*-
"""
Created on Mon Apr 25 11:26:52 2022
...
#exp1
initialh = 1
Out=trackball("C:/Users/Aadam/OneDrive - Coventry University/Documents/Chem Eng/LDA/Portfolio 2/20.mp4"
...
max_height1 = max(converted_ylist[48:])
cr = round(np.sqrt( max_height1/initialh),3)
#finding max height after second bounce
max_height2 = max(converted_ylist[77:])
cr2 = round(np.sqrt((max_height2/max_height1)),3)
#findind max height after third bounce 
max_height3 = max(converted_ylist[97:])
cr3= round(np.sqrt((max_height3/max_height2)),3)
