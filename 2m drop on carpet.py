# -*- coding: utf-8 -*-
"""
Created on Tue Apr 26 13:31:05 2022
...
initialh = 2
Out=trackball("C:/Users/Aadam/OneDrive - Coventry University/Documents/Chem Eng/LDA/Portfolio 2/105.mp4"
...
## creating list of y positions which are basically the bounce positions 
# will help set limits 
bounce_indexesH= [(i) for i, y in enumerate(converted_ylist) if y < 0.7]
#first to start from in the list when finding the max after first bounce
#lower limit is earliest index in y list which can be used to find max heights
lower_limit1 = bounce_indexesH[0]
height_after_bounce1 = max(converted_ylist[lower_limit1:] )
lower_limit2 = bounce_indexesH[0]
coefficent_of_restitution1 =  round(abs(np. sqrt((height_after_bounce1/initialh) )),3)
print("The coefficient of restitutions for your model was:",+ coefficent_of_restitution1)
