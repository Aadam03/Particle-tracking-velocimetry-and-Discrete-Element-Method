...
#exp1
initialh = 2
# I actually used the full file directory here from my files so put your file directory where it says 44.mp4
Out=trackball("\44.mp4"
...
#COR CALC
max_height1 = max(converted_ylist[9:])
